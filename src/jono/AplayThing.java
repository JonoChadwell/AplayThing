...
public class AplayThing {
   ...
   private static void parseArgs(String args[]) {
      for (String s : args) {
         ...
         // ifStarts((str) -> PAUSE = Double.valueOf(str), s, "-p=",
         // "--pause=");
         // ifStarts((str) -> FADE_RATE = Double.valueOf(str), s, "-f=",
         // "--fade=");
         // ifStarts((str) -> BASE_NOTE = Pitch.valueOf(str), s, "-n=",
         // "--note=");
         // ifStarts((str) -> BASE_CHORD = Chord.valueOf(str), s, "-c=",
         // "--chord=");
